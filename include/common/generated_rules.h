...
/* Backwards-compatible rule name macros (migrated from old registry.h).
 * These provide string literals for rule names used by macros in
 * include/common/registry/list.h and elsewhere. New code should prefer
 * the generated registry APIs instead of relying on these macros.
 */
/* Layout Rules */
/* clang-format off */
