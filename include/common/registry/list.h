...
#define LEUKO_RULES_LAYOUT                                                                                                                                                                 \
    X(indentation_consistency, LEUKO_RULE_CATEGORY_NAME_LAYOUT, LEUKO_RULE_NAME_INDENTATION_CONSISTENCY, &layout_indentation_consistency_rule, &layout_indentation_consistency_config_ops) \
    X(indentation_width, LEUKO_RULE_CATEGORY_NAME_LAYOUT, LEUKO_RULE_NAME_INDENTATION_WIDTH, &layout_indentation_width_rule, &layout_indentation_width_config_ops)                         \
    X(indentation_style, LEUKO_RULE_CATEGORY_NAME_LAYOUT, LEUKO_RULE_NAME_INDENTATION_STYLE, &layout_indentation_style_rule, &layout_indentation_style_config_ops)                         \
    X(line_length, LEUKO_RULE_CATEGORY_NAME_LAYOUT, LEUKO_RULE_NAME_LINE_LENGTH, &layout_line_length_rule, &layout_line_length_config_ops)
